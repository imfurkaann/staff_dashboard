...
export const permissions = {
  ...
  SHARED_ASSET_DELETE: 'SHARED_ASSET_DELETE',
...
export const rolePermissions: Record<AppRole, ReadonlySet<Permission>> = {
  ...
  HOUSING_STAFF: new Set([
    permissions.DASHBOARD_VIEW, permissions.EMPLOYEE_VIEW, permissions.EMPLOYEE_SENSITIVE_VIEW, permissions.EMPLOYEE_MANAGE, permissions.EMPLOYEE_EXPORT, permissions.ROOM_VIEW,
...
export const roleDescriptions: Record<AppRole, string> = {
  ...
  HOUSING_STAFF: 'Lojman operasyonlarının tüm günlük süreçleri; silme ve kullanıcı yönetimi hariç.',
...
export const permissionLabels: Record<Permission, string> = {
  ...
  STOCK_DELETE: 'Stok kartlarını silme',
  ...
  SHARED_ASSET_DELETE: 'Ortak eşya işlem kayıtlarını silme',
