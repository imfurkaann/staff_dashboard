...
router.get('/personnel-options', authorizePermissions(permissions.STOCK_MANAGE), stockController.getPersonnelOptions);
...
router.get('/:id/export.xlsx', authorizePermissions(permissions.STOCK_MANAGE), stockController.exportDetailExcel);
...
router.post('/:id/assign-personnel', authorizePermissions(permissions.STOCK_MANAGE), stockMutationRateLimiter, stockController.assignPersonnel);
