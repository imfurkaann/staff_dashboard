...
- Form artık stok kodunu cihaz kodu olarak kopyalamaz. Backend her cihaza benzersiz kod üretir; eski tarayıcı stok kodunu gönderirse de otomatik kod üretilir. Yönetim ekranında üretici seri numarası kullanılmaz.
...
Doğrulama: Ayrı PostgreSQL test veritabanında 53 migration uygulandı. Aynı karttan 100 benzersiz cihaz oluşturuldu; ilk iki cihazdan sonra kalan miktar 98 doğrulandı. 101. cihaz ve tekrar cihaz kodu reddedildi; aynı işlem anahtarını tekrar göndermek yeni cihaz oluşturmadı. Backend ve frontend derlemeleri başarılı.
